 ...
 * 번호가 아니라 code다 — 층 번호는 한 차례 재정렬된 적이 있어(2026-08-19
 * 피그마 기준으로 정리) 번호에 매면 그때마다 깨진다. 서버가 나중에
 * PRODUCT 블록을 주기 시작하면 그 블록을 그대로 쓰고 덧붙이지 않는다.
 */
const GUIDE_PRODUCT_IDS = {
  JOURNEY: [7, 8], // 피그마 45 여정 — 캐빈 트롤리 · 그라데이션 위켄더
  EMBLEM: [9], // 피그마 46 상징 — 뮌헨 비세토스 토트
  TRY: [10, 11], // 피그마 47 시도 — HIMMEL 쇼퍼 · ECONYL 위켄더 백팩
}
